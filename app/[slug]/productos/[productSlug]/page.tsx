...
export default async function ProductPage({ params }: any) {
  ...
  const storeSlug = resolvedParams.slug; // El slug de la tienda (ej: agro-gonzanama)
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Breadcrumb (Navegación con Contexto de Tienda) */}
        <nav className="flex mb-8 text-sm text-gray-500 overflow-x-auto whitespace-nowrap">
          <Link href={`/${storeSlug}`} className="hover:text-blue-600 font-bold uppercase tracking-wider">
            🏠 Volver a la Tienda
          </Link>
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 lg:flex">
          ...
          <div className="lg:w-1/2 p-8 lg:p-12 flex flex-col justify-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
                <a 
                    href={`https://wa.me/593999999999?text=Hola! Me interesa el producto "${product.nombre}" que vi en oferta en ${storeSlug} por $${esOferta ? product.precio_oferta : product.precio}`}
                    target="_blank"
